...
public class nodeObserver implements Observer {
	...
	public void update(Observable o, Object arg) 
	{
		...
		editFontPanel.getTextArea().setText("");
		 ...
		 for(Nodes n : cpy) 
		 {
			...
			//aggregate
			else if(n.isSingle == false && n.arrow.aggregate && n.start.iconClass == "rectangle" && n.end.iconClass == "rectangle")
			{
				changeText("\nPublic" 
	...
	{ 
		//this removes individual icons before linking to allow us to not reprint icons
